...
set(stdout_log "/home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-build-out.log")
set(stderr_log "/home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "fat_tool_build build command succeeded.  See also /home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
