...
set(stdout_log "/home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-install-out.log")
set(stderr_log "/home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "fat_tool_build install command succeeded.  See also /home/mm8/Documents/OS/MM8/MM8-OS/build/fat_tool_build-prefix/src/fat_tool_build-stamp/fat_tool_build-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
