...
#qemu-system-i386 -boot order=c -drive file=build/packaged.img,format=raw,if=none,id=usb_stick -device ich9-usb-ehci1,id=ehci -device usb-storage,bus=ehci.0,drive=usb_stick -m 512 